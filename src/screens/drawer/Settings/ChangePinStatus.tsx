...
const ChangePinStatusDetails: statusScreenDetailsType[] = [
    {
        title: 'Change PIN successful',
        description: 'You have successfully changed your security PIN for your wallet',
        button1: 'Done',
...
export type StatusScreenPropsType = {
    route: RouteProp<{ params: ChangePinStatusType }, 'params'>;
    navigation: NavigationAction
}

const ChangePinStatus = (props: StatusScreenPropsType) => {
    const { status, } = props.route.params
    let statusScreenDetails: statusScreenDetailsType[] = ChangePinStatusDetails.filter((item) => item.status == status)
...
export default ChangePinStatus

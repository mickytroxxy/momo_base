...
const initialState: { userAccounts: UserAccountType[]; currency:string; phoneNumber:string; transactions: transactionType[]; filters:TransactionFiltersType[] } = {
  userAccounts: userAccounts,
  transactions:[],
  currency:"GHc",
  phoneNumber:'+27 65 801 6132',
